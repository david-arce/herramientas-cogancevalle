...
cada mes + total por tabla). Si algo no cuadra, lanza un error y, como la
migración es atómica, no queda nada a medias.

Cómo usarla:
  1. python manage.py makemigrations <tu_app>              (crea PresupuestoArea)
  2. python manage.py makemigrations <tu_app> --empty --name migrar_presupuestos_areas
  3. Pega en ese archivo vacío todo lo de abajo, CONSERVANDO las
     `dependencies` que generó Django.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        # ⚠️ Deja aquí lo que generó `makemigrations --empty`, p. ej.:
        # ("presupuesto", "0042_presupuestoarea"),
    ]
