...
subprocess.run(['python', 'manage.py', 'inspectdb', 'venta', '>', 'conteoApp/models.py'], shell=True)

# Convertir el archivo models.py a UTF-8
input_file_path = 'conteoApp/models.py'
output_file_path = 'conteoApp/models.py'
