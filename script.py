...
file_path = 'presupuestoApp/models.py'
...
subprocess.run(['python', 'manage.py', 'inspectdb', 'bd_presupuesto_3', '>', 'presupuestoApp/models.py'], shell=True)

# Convertir el archivo models.py a UTF-8
input_file_path = 'presupuestoApp/models.py'
output_file_path = 'presupuestoApp/models.py'
...
# subprocess.run(['python', 'manage.py', 'makemigrations', 'presupuestoApp'], shell=True)
